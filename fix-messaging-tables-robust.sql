-- Robust fix for messaging tables - run this in your Supabase SQL editor
-- This script will handle any existing table structure and recreate everything properly

-- First, let's check what exists and drop everything safely
DO $$
BEGIN
...
CREATE TABLE public.messages (
    ...
    message_type TEXT DEFAULT 'text' CHECK (message_type IN ('text', 'file', 'image', 'feedback', 'ai-response')),
    file_url TEXT,
    file_name TEXT,
    file_size INTEGER,
